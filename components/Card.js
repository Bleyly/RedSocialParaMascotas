  ...
  return(
    posts.map((post) => {
      ...
      return(
        ...
        <ScrollView key={ post._id } /*key={ user._id }*/ style={{ marginBottom:8 }}>
          <Card>
            <Card.Title title= "Username" /*{ user.username }*/ left={ AvatarComponent } />
            <Card.Content>
              ...
              <Card.Cover 
                style= {{ width: null,
                          resizeMode: 'contain',
                          height: 320 }}  
                source={ /*require('../assets/imagen.jpg')*/ post.photos[(Math.random() * 3).toFixed(0)] }
              />
            </Card.Content>
            <Card.Content style={{ flex: 1, flexDirection: 'row', }}>
                <Text style={{ flex: 1, alignContent: 'flex-end', }} >{ post.likes }  Me gusta</Text>
            ...
            <Card.Actions style={{ flex: 1,
              ...
              <View style={{ flex: 1, }} >
                <MaterialCommunityIcons name="comment-text-outline"
                                        size={32}
                                        color="black"
                                        onPress={handlePress} />
              </View>
              <View style={{ flex: 8, }} >
                <MaterialCommunityIcons name="share-outline"
                                        size={32}
                                        color="black"
                                        onPress={handlePress} />
              </View>
